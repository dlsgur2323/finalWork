	...
	<div class="row row-deck row-cards">
		<div class="card">
				...
				<table class="table card-table table-vcenter text-nowrap datatable">
					...
					<tbody>
						<tr>
							...
							<td>150ml</td>							
							<td>120</td>
							<td><input type="text" class="inputrow" value="C-01-01"></td>
							<td>90000012345</td>							
							<td>두리화장품</td>							
						</tr>												
					</tbody>
			...
			<div class="card-footer editbtns">
				<button type="button" class="btn btn-light">위치수정</button> 
				<button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modal-team">실사등록</button> 
			</div>
